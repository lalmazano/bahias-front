...
class EstadoBahiaScreen extends StatelessWidget {
  const EstadoBahiaScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final estadoRef = FirebaseFirestore.instance.collection('Tipo_Estado');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: estadoRef.snapshots(),
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            return const Center(
              child: Text("Error al cargar estados",
          ...
          if (docs.isEmpty) {
            return const Center(
              child: Text("No hay estados registrados",
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () async {
                      await estadoRef.doc(docs[i].id).delete();
                    },
                  ),
                ),
              );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          _mostrarDialogoAgregar(context, estadoRef);
        },
      ),
    );
  }
